...
public struct Computation: RawRepresentable, OptionSet {
	...
	/// Whether to use the second operand as is or to replace it with the memory value at itself
	public static let i = Computation(rawValue: 0x1000)

	/// Whether to zero the value of the first operand.
	public static let zx = Computation(rawValue: 0x800)

	/// Whether to negate the value of the first operand.
	public static let nx = Computation(rawValue: 0x400)

	/// Whether to zero the value of the second operand.
	public static let zy = Computation(rawValue: 0x200)

	/// Whether to negate the value of the second operand.
	public static let ny = Computation(rawValue: 0x100)

	/// Whether to ADD or AND the operands together.
	public static let f = Computation(rawValue: 0x80)

	/// Whether to negate the output value.
